...
_((գլուխը խմբագրել ու թողնել միայն կոնստրուկտորների և Լիսպ կոդը գեներացնող ֆունկցիայի նկարագրությունը))_
...
Սակայն այստեղ մի խնդիր կա։ Քերականական սիմվոլների լռելության տիպը `int` է, իսկ, օրինակ, `create_while()` կոնստրուկտորը սպասում է `expression*` ու `statement*` և վերադրձնում է `statement*`։ Bison֊ի `%union` հրահանգը հնարավորություն է տալիս քերականական սիմվոլների տիպը սահմանել միավորման միջոցով։ Այսպես, վերլուծելով Բեյսիկի քերականությունը, տեսնում եմ, որ քերականական սիմվոլները վեց տիպի են․ թվային հաստատուն (`double`), իդենտիֆիկատոր (`char*`), արտահայտություն (`expression*`), հրաման (`statement*`), ֆունկցիա (`function*`) և զանազան ցուցակներ (`node*`)։ Bison֊ի նկարագրության ֆայլի առաջին՝ հայտարարությունների բաժնում գրում եմ `%union` հրահանգը՝ չմոռանալով `%{...%}` սեգմենտում կցել `ast.h` ֆայլը․
...
ապա Reduce գործողություններն ավելի շուտ են կատարվում, և, տվյալ օրինակի դեպքում, «ծախսվում» է ստեկի ամենաշատը երեք տարր։ Վելի մանրամասն տես [John Levine, _flex & bison_, O'Reilly Media, 2009](http://shop.oreilly.com/product/9780596155988.do) գրքում։ 
...
Եթե ֆունկցիայի վերնագիրը հանդիպել է որպես ֆունկցիայի հայտարարություն (`DECLARE`), ստեղծված `_function` օբյեկտն ավելացվում է ծրագրի ենթածրագրերի ցուցակին։ Իսկ եթե ֆունկցիայի վերնագիրը ֆունկցիայի սահմանման մաս է, ապա նախ՝ տվյալ անունով ֆունկցիան որոնվում է ծրագրի ենթածրագրերի ցուցակում
